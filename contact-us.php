...
.inquery input[type="number"], input[type="text"], input[type="email"], input[type="password"], input[type="tel"], input[type="url"], input[type="search"], select, textarea {
    display: block;
    width: 100%;
    height: 55px;
    font-size: 16px;
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12">
                              <div class="stellarnav">
                                <ul>
                                    ...
                                    <li> <a class="animation-button" style="padding: 10px 20px;" target="_blank" href="https://nextgenhomesireland.com/images/pdf/brochure.pdf">Brochure!!!</a><li>
                                </ul>
                              </div>
...
$message2 .= '<h3 style="text-align: center; color:#000;">Email: sales@nextgenhomesireland</h3>';
$message2 .= '</body></html>';     
...
<div class="cform">
  ...
  <form class="form"  method="POST" action="">
    ...
    <div class="col-md-6">
     <p class="useremail">
    <label for="email">Note<span class="required">*</span></label><br>

      <textarea  name="enquiry_detail" id="email" placeholder="Detail" required></textarea>
            ...
            <div class="col-xl-3 col-lg-5 col-md-12 col-sm-12">
              <div class="ftr-box">
                ...
                <ul class="ftr-contact">
                  <li class="contact-link"><span>Call: </span><a href="tel:+353 85 871 2377">+353 85 871 2377</a></li>
                                        <li class="contact-link"><span>Email: </span><a href="mailto:sales@nextgenhomesireland">sales@nextgenhomesireland</a></li>
